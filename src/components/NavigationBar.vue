    ...
    <div class="container">
      <div class="navbar-content">
        ...
        >
          ...
          <a href="#terminal-section" @click="closeMobileMenu" :style="getMenuItemStyle(1)">Terminal</a>
          <a href="#about" @click="closeMobileMenu" :style="getMenuItemStyle(2)">About</a>
          <a href="#achievements" @click="closeMobileMenu" :style="getMenuItemStyle(3)">Achievements</a>
          <a href="#skills" @click="closeMobileMenu" :style="getMenuItemStyle(4)">Skills</a>
          <a href="#projects" @click="closeMobileMenu" :style="getMenuItemStyle(5)">Projects</a>
          <a href="#experience" @click="closeMobileMenu" :style="getMenuItemStyle(6)">Experience</a>
          <a href="#testimonials" @click="closeMobileMenu" :style="getMenuItemStyle(7)">Testimonials</a>
          <a href="#contact" @click="closeMobileMenu" :style="getMenuItemStyle(8)">Contact</a>
        </div>
